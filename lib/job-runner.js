...
function buildCardSeriesPrompt(account) {
  ...
  return [
    ...
    '커버 첫 페이지의 headline 값은 고정 주제 개념을 활용한 짧은 한국어 문구로만 써라.',
    '커버 첫 페이지의 headline은 주제어를 포함하되, 주제어 뒤에 쉼표를 찍고, 주제어를 제외한 나머지 문구는 12자 이내로 써라. 예: "var, 제대로 알기", "return, 제대로 알기".',
    '커버 첫 페이지의 headline에는 프레임워크명, "공식문서", "쉽게 배우기", "#3/20" 같은 편수 표기를 절대 넣지 마라. 이 정보는 subtext에만 있어야 한다.',
